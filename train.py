...
def train(data_path, val_data_path, args, exp_name):
    ...
    train_loader, val_loader = get_dataloaders(data_path, val_data_path)
...
if __name__ == '__main__':
    ...
    train_data_path = "./{}/PAIR_DATASETS/TRAIN".format(dataset_name)
    test_data_path= "./{}/PAIR_DATASETS/TEST".format(dataset_name)
    ...
    random.seed(42)
    lr = 0.000001
    resnet_path = "resnet_{}.pth".format(dataset_name)
